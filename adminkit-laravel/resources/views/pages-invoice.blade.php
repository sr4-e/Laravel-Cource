    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body m-sm-3 m-md-5">
                <div class="mb-4">
                    Hello <strong>Charles Hall</strong>,<br /> This is the receipt for a payment of <strong>$268.00</strong> (USD) you made to AdminKit Demo.
                </div>
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="text-center">
                    ...
                    <a href="#" class="btn btn-primary">Print this receipt</a>
                </div>
            </div>
        </div>
    </div>
